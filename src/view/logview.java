        ...
        logbtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!getRepwd().equals(getpwd())) {
                    ...
                    JOptionPane.showMessageDialog(null, "一卡通不能为空！", "提示", JOptionPane.WARNING_MESSAGE);
                else if (getName().equals(""))
                    JOptionPane.showMessageDialog(null, "姓名不能为空！", "提示", JOptionPane.WARNING_MESSAGE);
                else if (getAge() == 0)
                    JOptionPane.showMessageDialog(null, "年龄不能为空！", "提示", JOptionPane.WARNING_MESSAGE);
                else if (getpwd().equals("") || getRepwd().equals(""))
                    JOptionPane.showMessageDialog(null, "密码不能为空！", "提示", JOptionPane.WARNING_MESSAGE);
                else if (getSex().equals(""))
                    JOptionPane.showMessageDialog(null, "性别必须明确！", "提示", JOptionPane.WARNING_MESSAGE);
                else if (getItem().equals(""))
                    JOptionPane.showMessageDialog(null, "身份必须明确！", "提示", JOptionPane.WARNING_MESSAGE);
                else {
